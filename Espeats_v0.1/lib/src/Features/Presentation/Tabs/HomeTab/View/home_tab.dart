import 'package:espeats/src/Features/Presentation/Widgets/headers_text.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: headerText("Descubre nuevos lugares",
...
Widget _headers( BuildContext contex, String textHeader, String textAction){
  return Row(
    children: [
      Container(
          alignment: Alignment.centerLeft,
          child: headerText(textHeader,
              Colors.black, FontWeight.bold, 20.0)
      ),
      const Spacer(),
      GestureDetector(
        child: Row(
              ...
              child: Column(
                ...
                children: [
                  Container(
                      ...
                      child: headerText("Don Diego", Colors.black, FontWeight.bold, 17.0)),
                  Container(
                    alignment: Alignment.centerLeft,
