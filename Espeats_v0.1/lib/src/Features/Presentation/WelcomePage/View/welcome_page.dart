...
//Widgets
import '../../Widgets/headers_text.dart';
//services
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: headerText("Cansado de ser pobre y vivir lejos? Se solo pobre",
                    Colors.white,FontWeight.bold, 45.0)
              ),
              /*
              const Text("Cansado de ser pobre y vivir lejos? Se solo pobre", style: TextStyle(
                  color: Colors.white,
